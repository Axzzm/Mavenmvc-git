...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            ${ctx}/shop/shopSearch.action?goodname='+goodname+'&operator=page'
            ,cols: [[
              {type:'checkbox'}
              ,{field:'id', width:80, title: 'ID', sort: true}
              ,{field:'goodname', width:80, title: '商品名',edit: 'text'}
...
<form action="${ctx}/user/login.action" method="post" id="login">
    ...
    <input type="hidden" class="layui-btn" value="搜索" id="search" style="width: 70px ;height: 32px"/><input
        id="searchtext" style="width: 400px;height: 30px" type="hidden" name="search" placeholder="请输入内容"
        autocomplete="off">
